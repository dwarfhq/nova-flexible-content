...
interface ResolverInterface
{
     ...
     * @see https://Dwarf.github.io/nova-flexible-content/#/?id=resolving-the-field
     *
     * @param  mixed  $resource
     * @param  string  $attribute
     * @param  \Dwarf\NovaFlexibleContent\Layouts\Collection  $layouts
     * @return  \Illuminate\Support\Collection<array-key, \Dwarf\NovaFlexibleContent\Layouts\Layout>
     */
    public function get($resource, $attribute, $layouts);

    /**
     * Save the Flexible field's content somewhere the get method will be able to access it.
     * @see https://Dwarf.github.io/nova-flexible-content/#/?id=filling-the-field
     *
     * @param  mixed  $resource
     * @param  string  $attribute Attribute name set for a Flexible field.
     * @param  \Illuminate\Support\Collection<int, \Dwarf\NovaFlexibleContent\Layouts\Layout>  $groups
     * @return  mixed
     */
